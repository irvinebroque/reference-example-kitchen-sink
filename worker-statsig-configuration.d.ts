/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.statsig.jsonc --env-interface=StatsigEnv worker-statsig-configuration.d.ts` (hash: 5243231eb27c15027cc7b959fb82c792)
// Runtime types generated with workerd@1.20260722.1 2026-07-26 memory_cache_delete,nodejs_compat
interface __BaseEnv_StatsigEnv {
	APP_ID: "reference-app";
	APP_ENVIRONMENT: "staging" | "production";
	EVALUATOR_VERSION: "staging" | "local";
	STATSIG_CLIENT_KEY: "client-reference-example";
	CONFIG_SPECS_TTL_SECONDS: "60" | "300";
	BOOTSTRAP_TTL_SECONDS: "30" | "60";
	BOOTSTRAP_STALE_SECONDS: "60" | "300";
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		BOOTSTRAP_TTL_SECONDS: "30";
		BOOTSTRAP_STALE_SECONDS: "60";
		STATSIG_SERVER_SECRET: string;
		USER_CACHE_HMAC_SECRET: string;
		INVALIDATION_SECRET: string;
		CONFIG_SPECS_CACHE: any;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ID" | "APP_ENVIRONMENT" | "EVALUATOR_VERSION" | "STATSIG_CLIENT_KEY" | "CONFIG_SPECS_TTL_SECONDS" | "BOOTSTRAP_TTL_SECONDS" | "BOOTSTRAP_STALE_SECONDS" | "STATSIG_SERVER_SECRET" | "USER_CACHE_HMAC_SECRET" | "INVALIDATION_SECRET">> {}
}
