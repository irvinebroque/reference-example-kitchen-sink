/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.statsig.jsonc --env-interface=StatsigEnv worker-statsig-configuration.d.ts` (hash: c8baaca3f921ba97754531b1411ec70e)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ID" | "APP_ENVIRONMENT" | "EVALUATOR_VERSION" | "STATSIG_CLIENT_KEY" | "RULESET_TTL_SECONDS" | "BOOTSTRAP_TTL_SECONDS" | "BOOTSTRAP_STALE_SECONDS" | "STATSIG_SERVER_SECRET" | "USER_CACHE_HMAC_SECRET" | "INVALIDATION_SECRET">> {}
}
