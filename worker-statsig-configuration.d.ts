/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.statsig.jsonc --env-interface=StatsigEnv worker-statsig-configuration.d.ts` (hash: 221738810ac0b78c5143b80f9927401b)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENVIRONMENT" | "EVALUATOR_VERSION" | "RULESET_TTL_SECONDS" | "BOOTSTRAP_TTL_SECONDS" | "BOOTSTRAP_STALE_SECONDS" | "STATSIG_SERVER_SECRET" | "USER_CACHE_HMAC_SECRET" | "REFRESH_SECRET">> {}
}
