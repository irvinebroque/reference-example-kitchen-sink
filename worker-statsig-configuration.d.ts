/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.statsig.jsonc --env-interface=StatsigEnv worker-statsig-configuration.d.ts` (hash: 76c9564c306242098ee6c7200dfe7dee)
